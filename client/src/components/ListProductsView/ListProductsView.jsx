...
const ListProductsView = ({ data, type }) => {
  ...
  const titleMap = {
    ...
    "mens-jeans": "Men's Jeans & Denim Pants",
  ...
  const faqsQues1Map = {
    ...
    "mens-jeans": "How should I wash jeans for men?",
    "mens-all": "Shop All Men's Clothing & Apparel",
    "womens-all": "Shop All Women's Clothing & Apparel",
    "best-sellers": "Best Selling Clothing & Apparel",
  };
  ...
  const faqsQues2Map = {
    ...
    "mens-jeans": "How should mens jeans fit?",
    "mens-all": "Shop All Men's Clothing & Apparel",
    "womens-all": "Shop All Women's Clothing & Apparel",
    "best-sellers": "Best Selling Clothing & Apparel",
  };
  ...
  const faqsQues3Map = {
    ...
    "mens-jeans": "What are the most comfortable jeans for men?",
    "mens-all": "Shop All Men's Clothing & Apparel",
    "womens-all": "Shop All Women's Clothing & Apparel",
    "best-sellers": "Best Selling Clothing & Apparel",
  };
  ...
  const faqsAns1Map = {
    ...
    "womens-all-shirts-tops":
      "The best shirts for a professional work environment typically include tailored button-down shirts, dress shirts, and classic polos. These provide a polished and business-appropriate look.",
    "mens-jeans":
      "To maintain the color and fit of men's jeans, wash them inside out in cold water and avoid using harsh detergents. Hang them to air dry rather than using a dryer to prevent excessive fading and shrinking.",
    "mens-all": "Shop All Men's Clothing & Apparel",
    "womens-all": "Shop All Women's Clothing & Apparel",
    "best-sellers": "Best Selling Clothing & Apparel",
  };
  ...
  const faqsAns2Map = {
    ...
    "mens-jeans":
      "Men's jeans should have a comfortable but not overly loose fit. They should sit at the waist and have a straight or slim-leg cut, depending on your personal preference.",
    "mens-all": "Shop All Men's Clothing & Apparel",
    "womens-all": "Shop All Women's Clothing & Apparel",
    "best-sellers": "Best Selling Clothing & Apparel",
  };
  ...
  const faqsAns3Map = {
    ...
    "womens-all-shirts-tops":
      "Men's t-shirts should have a comfortable, but not overly loose, fit. They should skim the body without being too tight or baggy, with sleeves ending mid-bicep. The hem should fall around the hip area for a classic look.",
    "mens-jeans": `Comfort in jeans can be subjective, but our "The Authentic Stretch Jeans" and "The Athletic Fit Jean" are known for their comfortable stretch and flexibility, making them excellent options for all-day wear.`,
    "mens-all": "Shop All Men's Clothing & Apparel",
    "womens-all": "Shop All Women's Clothing & Apparel",
    "best-sellers": "Best Selling Clothing & Apparel",
  };

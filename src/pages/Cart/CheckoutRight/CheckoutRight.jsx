          ...
          <div className="flex w-full gap-3">
            ...
            <div className="flex flex-1 flex-col justify-between">
              <div className="flex justify-between">
                <div>
                  <h4>The Relaxed Oxford Shirt</h4>
                  <p className="text-sm text-[#737373]">Size 0 | White</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <span className="mr-1 text-xs text-[#737373] line-through">
                    ₫2216000
                  </span>
                  <span className="text-xs font-semibold">₫2,216,000</span>
                </div>
                <div className="flex">

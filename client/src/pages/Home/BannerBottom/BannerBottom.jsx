...
const BannerBottom = () => {
  return (
    <div className="flex min-h-[550px] items-center justify-center bg-gray-100 py-12 dark:bg-[#000F0A] sm:py-0 ">
      <div className="container rounded-3xl py-10 dark:bg-[#18191a]">
        <div className="grid grid-cols-1 items-center gap-6 sm:grid-cols-2">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            ...
            <p
              data-aos="fade-up"
              className="text-sm leading-4 tracking-wide text-gray-400"
            >

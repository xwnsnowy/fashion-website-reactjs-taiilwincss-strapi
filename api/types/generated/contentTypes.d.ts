...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    number_of_sales: Attribute.Integer & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductImageProductImage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    img_3: Attribute.Media;
    img_4: Attribute.Media;
    product_size_colors: Attribute.Relation<
...
export interface ApiProductSizeColorProductSizeColor
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    size: Attribute.Relation<
      ...
      'api::size.size'
    >;
    product_image: Attribute.Relation<
      'api::product-size-color.product-size-color',
      'manyToOne',
      'api::product-image.product-image'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::product-size-color.product-size-color': ApiProductSizeColorProductSizeColor;
